...
class Wpe_Content_Engine {
	...
	private function load_dependencies() {
		...
		*/
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'helper/sync/entity/wordpress/asset.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'helper/sync/batches/asset.php';
	...
	private function define_admin_hooks() {
		...
		$content_engine_sync_asset = new Show_Admin_Notice_Handler_Decorator( new Asset_Entity( $this->client, $this->settings ) );
		...
		// Asset (Attachment) hooks.
		$this->loader->add_action( 'add_attachment', $content_engine_sync_asset, 'upsert', 10, 1 );
		$this->loader->add_action( 'attachment_updated', $content_engine_sync_asset, 'upsert', 10, 2 );
		$this->loader->add_action( 'edit_attachment', $content_engine_sync_asset, 'upsert', 10, 2 );
